    ...
    <div class="panel panel-default" style="margin-top:150px;margin-left:30%;margin-right:30%;min-width:500px">
        <div class="panel-body">
            <div id="superior_panel" >
                <h2 class="text-center" style="width:100%"><small>Registro</small></h2>
                ...
                <asp:TextBox style="width:100%;color:grey" runat="server" id="nombre_Usuario" CssClass="form-control"></asp:TextBox> 
                <br />

                <label style="color:grey" class="control-label">Apellidos:</label>
                <asp:TextBox style="width:100%;color:grey" runat="server" id="apellidos_Usuario" CssClass="form-control"></asp:TextBox> 
                <br />

                <label style="color:grey" class="control-label">Email:</label>
                <asp:TextBox style="width:100%;color:grey" runat="server" id="email_Usuario" TextMode="Email" CssClass="form-control"></asp:TextBox> 
                <br />

                <div class="col-xs-6">
                    <label style="color:grey" class="control-label"">Contraseña:</label>
                    <asp:TextBox style="width:100%" runat="server" id="pass1_Usuario" TextMode="Password" CssClass="form-control"></asp:TextBox> 
                </div>
                    <div class="col-xs-6">
                    <label style="color:grey" class="control-label">Confirmar Contraseña:</label>
                    <asp:TextBox style="width:100%" runat="server" id="pass2_Usuario" TextMode="Password" CssClass="form-control"></asp:TextBox> 
                </div>
                <br />
                <br />
                <br />
